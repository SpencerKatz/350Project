...
HD_PWD='C:/Users/sek49/Documents/350Project/processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Wrapper_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Wrapper_tb.tcl
