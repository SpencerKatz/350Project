...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets CPU/execute/ALU/added/G0];
...
##Buttons
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { reset2 }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
